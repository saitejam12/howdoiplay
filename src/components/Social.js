...
let donationQuote = donationquotearray[Math.floor(Math.random() * donationquotearray.length)];
  ...
  return (
    <div>
      <div id='links'>
        ...
        <button id='paypal-button' className='paypal' title='Help support the site!'>
          <span className='paypal-button-logo'></span>
          {/* <a
            target='_blank'
            rel='noopener noreferrer'
            title='Paypal'
            href='https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=9YV8EDYT2T3NS'
